...
import by.bsuir.OTS.Kalenik.grapheditor.models.VertexModelEvent;
import by.bsuir.OTS.Kalenik.grapheditor.views.EdgeView;
import by.bsuir.OTS.Kalenik.grapheditor.views.GraphView;
...
public class GraphController extends Controller {
	...
	private final List<EdgeController> edgs = new ArrayList<EdgeController> ();
	...
	private final List<EdgeView> selectedEdges = new ArrayList<EdgeView> ();
	...
	public void addEdgeToSelection(EdgeView edge) {
		if (!isSelected(edge)) {	
	...
	public void select(EdgeView edge) {
		deselectEdge();
		selectedEdge = edge;
		edge.getModel().setOriginColor(edge.getModel().getColor());
		edge.setColor(Color.BLUE);
	...
	public void deselectEdge() {
		if (selectedEdge != null) {
			selectedEdge.setColor(selectedEdge.getModel().getOriginColor());
			selectedEdge = null;
		}
	}
	...
	public boolean isSelected(EdgeView edge) {
	...
	public List<VertexView> getSelectedVertices() {
	...
	public EdgeView getSelectedEdge(){
		return selectedEdge;
	}
