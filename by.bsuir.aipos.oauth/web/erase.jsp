<%-- 
    Document   : erase
    Created on : 24.10.2013, 10:29:56
    Author     : Александр
--%>
...
<html>
    ...
    <body>
        <h1><center>Страница удаления понятий</center></h1>
...
<div class="general_menu">
    ...
    <td>
  	 ...
  	 Форма удаления понятия:
    	<table width="200" border="0">
        <form name="form1" method="post" action="JServlet">
      
  <tr>
    <td>Название:</td>
    <td><input type="text" name="erasingName"/></td>
  </tr>
  <tr>
